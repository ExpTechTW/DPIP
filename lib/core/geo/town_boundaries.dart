...
class TownBoundaries {
  ...
  /// Township [code]'s bounding box as `[minLng, minLat, maxLng, maxLat]`, or
  /// null if unknown — for framing the map on a selected region.
  List<double>? boundsFor(String code) {
