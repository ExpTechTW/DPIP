...
Future<void> loadWindImage(MapLibreMapController controller) async {
  ...
  await controller.addImage("wind-middle", Uint8List.sublistView(await rootBundle.load("assets/map/icons/wind-middle.png")));
  await controller.addImage("wind-high", Uint8List.sublistView(await rootBundle.load("assets/map/icons/wind-high.png")));
}
