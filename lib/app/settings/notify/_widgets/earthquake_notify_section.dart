...
class _EarthquakeNotifySectionState extends State<EarthquakeNotifySection> {
  ...
  Widget build(BuildContext context) {
    final values = {
      EarthquakeNotifyType.all: (title: '接收全部', icon: Symbols.notification_add_rounded),
      EarthquakeNotifyType.localIntensityAbove1: (title: '所在地震度1以上', icon: Symbols.notifications_rounded),
