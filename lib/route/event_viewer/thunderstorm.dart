...
class _ThunderstormPageState extends State<ThunderstormPage> {
  ...
  Widget _buildColorBar() {
    return SizedBox(
      height: 20,
      width: 300,
      child: CustomPaint(painter: ColorBarPainter(dBZColors)),
    );
  }
  ...
  Widget _buildTimeBar(
    ...
    final Duration elapsed =
        isExpired ? duration : DateTime.now().difference(sendTime);
      ...
      child: Column(
        ...
        children: [
          _buildTimeInfo(
            ...
            context.i18n.history_send_time,
            sendTime,
          ),
          const SizedBox(height: 12),
          _buildTimeInfo(
            ...
            context.i18n.history_valid_until,
            expireTime,
          ),
          ...
          Stack(
            children: [
              LinearProgressIndicator(
                ...
                color:
                    isExpired ? context.colors.outline : context.colors.primary,
